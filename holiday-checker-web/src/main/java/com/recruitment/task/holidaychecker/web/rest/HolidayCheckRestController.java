...
import com.recruitment.task.holidaychecker.model.validation.group.OrderOfChecks;
...
public class HolidayCheckRestController {
    ...
    public HolidayCheckResponse checkHoliday(@RequestBody @Validated(OrderOfChecks.class) HolidayCheckRequest holidayCheckRequest, BindingResult bindingResult) {
